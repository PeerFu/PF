...
})({"jlihj":[function(require,module,exports) {
"use strict";
...
module.bundle.HMR_BUNDLE_ID = "fb6d52ffdc1bec00";
...
},{}],"1uanQ":[function(require,module,exports) {
...
(0, _utils.preloadImages)(".grid__item-img").then((_)=>{
    ...
    gridItems.forEach((item)=>{
        ...
        (0, _gsap.gsap).timeline().set(image, {
            transformOrigin: `0% 100%`
        }).to(image, {
            ease: "back.in(2)",
            scaleX: 0,
            scaleY: 2.5,
            skewY: (0, _gsap.gsap).utils.random(-5, 5),
            scrollTrigger: {
                trigger: item,
                start: "top 70%",
                end: "bottom top",
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["jlihj","1uanQ"], "1uanQ", "parcelRequiredfe1")

//# sourceMappingURL=index6.dc1bec00.js.map
