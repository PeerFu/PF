...
(0, _utils.preloadImages)(".grid__item-img").then((_)=>{
    ...
    gridItems.forEach((item)=>{
        ...
        const yPercentRandomVal = (0, _gsap.gsap).utils.random(-100, 100);
        (0, _gsap.gsap).timeline().addLabel("start", 0).to(image, {
            ease: "none",
            borderRadius: "50%",
            scrollTrigger: {
                trigger: item,
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["dIugA","7R80h"], "7R80h", "parcelRequiredfe1")
