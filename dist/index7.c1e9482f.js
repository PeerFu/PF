...
})({"hSEQf":[function(require,module,exports) {
"use strict";
...
module.bundle.HMR_BUNDLE_ID = "68c8f492c1e9482f";
...
},{}],"fAsus":[function(require,module,exports) {
...
(0, _utils.preloadImages)(".grid__item-img").then((_)=>{
    ...
    gridItems.forEach((item)=>{
        (0, _gsap.gsap).timeline().set(grid, {
            perspective: 1000,
            ...
            scrollTrigger: {
                ...
                scrub: true,
                onUpdate: (self)=>(0, _gsap.gsap).set(grid, {
                        perspectiveOrigin: ()=>`50% ${winsize.height / 2 + lenis.scroll}px`
                    })
            }
        });
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["hSEQf","fAsus"], "fAsus", "parcelRequiredfe1")

//# sourceMappingURL=index7.c1e9482f.js.map
